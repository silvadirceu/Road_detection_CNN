...
class RoadDetectionModel:
    ...
    def train(self):
        ...
        with Progress() as progress:
            ...
            progress.update(train_task, advance=1, description="[cyan]Building CNN Model...")
            # CNN Model
            model = Sequential()
            ...
            progress.update(train_task, advance=1, description="[cyan]Compiling Model...")
            # Training
            model.compile(
                optimizer="adam",
            ...
            progress.update(train_task, advance=1, description="[cyan]Model Training Complete.")

            # Model Evaluation
            progress.update(train_task, advance=1, description="[cyan]Evaluating Model...")
            model.evaluate(X_test, y_test, verbose=0)

            # Save Trained Model
            progress.update(train_task, advance=1, description="[cyan]Saving Trained Model...")
